...
var require_rut = __commonJS({
  "node_modules/rut.js/index.js"(exports, module) {
    function clean(rut) {
    ...
    function getCheckDigit(input) {
      ...
      const sumResult = rut.reverse().reduce(
...
export default require_rut();
//# sourceMappingURL=rut__js.js.map
